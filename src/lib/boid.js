import { context, point } from './canvas'
...
export class Boid extends Vehicle {
  ...
  draw () {
    ...
    context.moveTo(this.pos.x + this.points[0].x, this.pos.y + this.points[0].y)
    context.lineTo(this.pos.x + this.points[1].x, this.pos.y + this.points[1].y)
    context.lineTo(this.pos.x + this.points[2].x, this.pos.y + this.points[2].y)
    context.closePath()
    context.fill()
